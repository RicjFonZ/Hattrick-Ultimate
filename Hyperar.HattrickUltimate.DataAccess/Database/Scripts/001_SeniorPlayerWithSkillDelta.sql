...
SELECT [sp].[Id]
     ...
     , CAST([sp].[Agreeability] AS int) AS [Agreeability]
     , CAST([sp].[Aggressiveness] AS int) AS [Aggressiveness]
     , CAST([sp].[Honesty] AS int) AS [Honesty]
     , CAST([sp].[Leadership] AS int) AS [Leadership]
     , CAST([sp].[Specialty] AS int) AS [Specialty]
     , [sp].[Wage]
     , [sp].[CareerGoals]
     , [sp].[CareerHattricks]
     , [sp].[BookingStatus]
